function fs_segTouchup(P,isSmooth,conn)
...
am = load_untouch_nii([dirname filesep baseFilename '.nii']);
gray_temp = zeros(size(am.img,1),size(am.img,2),size(am.img,3));
white_temp = zeros(size(am.img,1),size(am.img,2),size(am.img,3));
csf_temp = zeros(size(am.img,1),size(am.img,2),size(am.img,3));
bone_temp = zeros(size(am.img,1),size(am.img,2),size(am.img,3));
skin_temp = zeros(size(am.img,1),size(am.img,2),size(am.img,3));
air_temp = zeros(size(am.img,1),size(am.img,2),size(am.img,3));

gray_temp(am.img == 1) = 1;
white_temp(am.img == 2) = 1;
csf_temp(am.img == 3) = 1;
bone_temp(am.img == 4) = 1;
skin_temp(am.img == 5) = 1;
air_temp(am.img == 6) = 1;
...
save_nii(white,[dirname filesep baseFilename '_masks.nii']);