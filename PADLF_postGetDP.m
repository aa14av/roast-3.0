function [vol_all,ef_mag,ef_all] = PADLF_postGetDP(P1,P2,node,hdrInfo,uniTag,indSolved,indInCore)
...
%     vol_all = F(xi,yi,zi);
    ...
    save([dirname filesep baseFilename '_' uniTag '_roastResult.mat'],'ef_all','ef_mag','-v7.3');
